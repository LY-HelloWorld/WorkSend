...
/**
 * Created by LeonShannon on 2018/3/20
 */
...
public class WXPayUtils {
     ...
     * 调起微信支付的方法,需要在客户端签名
     **/
    public void toWXPayAndSign(final Context context) {
        ...
        Runnable payRunnable = new Runnable() {  //这里注意要放在子线程
            ...
            public void run() {
                if (TextUtils.isEmpty(MyApplication.APP_ID)
                    ...
                    MyLog.e("WXPayUtils", "run(WXPayUtils.java:43)" + "必须在builder中设置appId、PartnerId、PrepayId");
                    return;
                }
                ...
                request.sign = genPackageSign(signParams, "BEIJINGjiaodianbaba6666668888888");
