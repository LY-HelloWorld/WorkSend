...
public class FindCompanyListActivity extends BaseActivity {
    ...
    public static void startFindCompanyListActivity(Context context, String company) {
        Intent intent = new Intent(context, FindCompanyListActivity.class);
    ...
    private void initWebView() {
        ...
        MyLog.e("FindCompanyActivity", "initWebView(FindCompanyActivity.java:97)" + MyApplication.h5Path + "/searchResult?company=" + company + "&longitude=" + MyApplication.longitude
                + "&latitude=" + MyApplication.latitude);
       //web_findcompany.loadUrl(MyApplication.h5Path + "/lookCompany");
    }
    ...
    private void setRegister() {
        return_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FindCompanyListActivity.this.finish();
            }
        });
    }
    ...
    class GetFromH5{
        ...
        public void startFindActivity(){
            SearchActivity.startSearchActivity(FindCompanyListActivity.this, SearchActivity.COMPANY);
        }

        @JavascriptInterface
        public void finishFromH5(){
            ActivityCollector.removeActivity(FindCompanyListActivity.this);
        }
        @JavascriptInterface
        public void toast2(){
