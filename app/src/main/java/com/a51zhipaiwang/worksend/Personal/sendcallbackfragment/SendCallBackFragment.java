package com.a51zhipaiwang.worksend.Personal.sendcallbackfragment;
...
import com.a51zhipaiwang.worksend.Personal.sendcallbackactivity.SendCallBackActivity;
import com.a51zhipaiwang.worksend.Personal.sendcallbackfragment.contract.ISendCallBackContract;
import com.a51zhipaiwang.worksend.Personal.sendcallbackfragment.presenter.ISendCallBackPresenter;
 ...
 * </pre>
 */
public class SendCallBackFragment extends BaseInfomationFragment implements ISendCallBackContract.View{

    private boolean showOrNot = false;
    private SendCallBackClicklistener sendCallBackClicklistener;
    private ISendCallBackContract.Presenter presenter;
    private LocalReceiver localReceiver;

    private TextView tx_call_back;
    ...
    public static SendCallBackFragment newInstance(){
        return new SendCallBackFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_callback_infomation, null);
        init(view);
        setRegister();
        initBroadCast();
    ...
    public void setCallBackList(Object object) {
        if (object != null){
            lv_send_back.setVisibility(View.VISIBLE);
            Infor infor = (Infor) object;
            tx_call_back.setText("您投递的" + infor.getCorporateName() + "投递反馈失败");
            ...
            lv_send_back.setVisibility(View.GONE);
        }
    }
    ...
    private void init(View view){
        presenter = new ISendCallBackPresenter(this);
        tx_call_back = (TextView) view.findViewById(R.id.tx_call_back);
    ...
    private void setRegister(){
        sendCallBackClicklistener = new SendCallBackClicklistener();
        lv_send_back.setOnClickListener(sendCallBackClicklistener);
        img_delete_infomation.setOnClickListener(sendCallBackClicklistener);
    }
    ...
    private void getInfo(){
        ...
        presenter.getCallBackInfoList(hashMap);
    }

    class SendCallBackClicklistener implements View.OnClickListener{
        @Override
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.lv_send_back:
                    tx_read.setText("已读");
                    tx_read.setTextColor(getResources().getColor(R.color.blue_green));
                    SendCallBackActivity.startSendCallBackActivity(getActivity());
                    break;
                case R.id.img_delete_infomation:
                    HashMap hashMap = new HashMap();
                    hashMap.put("", "020");
                    presenter.deleteCallBackItem(hashMap);
                    break;
            }
        }
    }
