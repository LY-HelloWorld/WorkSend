package com.a51zhipaiwang.worksend.Personal.sendcallbackactivity.model;
 ...
 * </pre>
 */
public class ISendCallBackActivityModel implements ISendCallBackActivityContract.Model {
    @Override
    public void getSendBackInfoList(Map map, final IBaseCallBack iBaseCallBack) {
