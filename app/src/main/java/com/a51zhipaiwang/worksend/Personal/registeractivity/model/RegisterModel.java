package com.a51zhipaiwang.worksend.Personal.registeractivity.model;
...
public class RegisterModel implements RegisterContract.Model {
    @Override
    public void getVerifiyCode(HashMap map, final IBaseCallBack iBaseCallBack) {
    ...
    @Override
    public void register(HashMap map, final IBaseCallBack iBaseCallBack) {
        MyApplication.requestQueue.add(new PersonalStringRequest(Request.Method.POST,
                MyApplication.path + "",
                map,
                new Response.Listener<String>() {
