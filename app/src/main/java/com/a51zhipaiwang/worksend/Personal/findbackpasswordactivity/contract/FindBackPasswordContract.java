package com.a51zhipaiwang.worksend.Personal.findbackpasswordactivity.contract;
 ...
 * </pre>
 */
public interface FindBackPasswordContract {
    interface Model {


        public void getVerifiyCode(HashMap map, IBaseCallBack iBaseCallBack);

        public void changePassword(HashMap map, IBaseCallBack iBaseCallBack);
