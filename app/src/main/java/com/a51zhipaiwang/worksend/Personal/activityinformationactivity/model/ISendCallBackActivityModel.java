package com.a51zhipaiwang.worksend.Personal.activityinformationactivity.model;
 ...
 * </pre>
 */
public class ISendCallBackActivityModel implements IActivityCallBackActivityContract.Model {

    @Override
    public void getActivityBackInfoList(Map map, final IBaseCallBack iBaseCallBack) {
